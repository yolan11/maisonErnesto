                ...
                <div class="bg-white w-[500px] flex justify-center items-center">
                    <div class=" w-full h-full flex flex-col justify-center items-center">
                        <form id="updateUserForm" action="{{ route('User.update', $user->id) }}" method="POST" class="w-full flex flex-col justify-center align-center">
                            @method('PUT')
                            @csrf
                            <input name="editName" id="editName" type="text" placeholder="Nom" class="m-4 " required>
                            <input name="editEmail" id="editEmail" type="email" placeholder="Email" class="m-4" required>
                            <input name="editPassword" id="editPassword" type="password" placeholder="Mot de passe" class="m-4" required>
                            <input name="editPassword_confirmation" id="editPassword_confirmation" type="password" placeholder="Confirmation de mot de passe" class="m-4" required>
