...
<section id="sidebar" class="border-r border-gray-600 fixed bottom-0 left-0 w-[280px] h-calc-100-minus-50 bg-white
    ...
    <div class="flex flex-col gap-2 p-4">
        <div class="w-full ">
            <a href="{{ route('Dashboard') }}" class="w-full px-4 py-2 flex items-center hover:bg-gray-200 gap-2 {{ Request::is('dashboard') ? 'active' : '' }}">
        ...
        <div class="w-full ">
            <a href="{{ route('DashboardUser') }}" class="w-full px-4 py-2 flex items-center hover:bg-gray-200 gap-2 {{ Request::is('dashboard/user') ? 'active' : '' }}">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor " class="w-6 h-6">
        ...
        <div class="w-full">
            <a href="{{ route('DashboardBrand') }}" class="w-full px-4 py-2 flex items-center hover:bg-gray-200 gap-2 {{ Request::is('dashboard/brand') ? 'active' : '' }}">
